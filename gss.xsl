...
<xsl:stylesheet version="2.0" 
        ...
        <table class="copyright" id="table_copyright">
          <tr>
            <td>
              ...
              Google Sitemaps Stylesheets by : <a href="http://www.trust.vn" target="_blank">TRUST.vn</a>
            </td>
          </tr>
        </table>
      </body>
  ...
  <xsl:template name="sitemapTable">
    <h3>This Google Sitemap file was created by <a href="http://www.trust.vn" target="_blank">TRUST.vn</a></h3>          
