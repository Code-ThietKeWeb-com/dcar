...
{data.err}
    ...
    <div class="container-fluid">
        ...
        <table width="100%"  border="0"  cellspacing="1" cellpadding="1" class="admintable">
            ...
            <tr>
                <td class="row1" valign="top" width="150" nowrap="" >Friendly Title :</td>
    ...
    <div class="container-fluid" style="margin-top: 15px">
         <div class="row-title"><div class="f-title">{LANG.setting_module}</div></div>
          <table width="100%"  border="0"  cellspacing="1" cellpadding="1" class="admintable">
                ...
                <tr >
                    <td   class="row1" width="150" nowrap=""> <strong>{LANG.n_list} : </strong></td>
                ...
                <tr>
                    <td class="row1" nowrap="" >{LANG.imgthumb_width} :</td>
                ...
                <tr>
                    <td  class="row1" nowrap="" >{LANG.img_width} :</td>
