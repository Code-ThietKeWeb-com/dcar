...
class XiTemplate {
    ...
    */
	...
	public function _maketree ($con, $parentblock='') {
		...
		if($vnT->lang_name=="vn")
		{
			$thietkeweb = "<a href='http://www.thietkeweb.com' target='_blank' title='thiet ke web' rel='dofollow' class='thietkeweb' >Thiết kế web :</a>";
			if($vnT->deviceType == "mobile") {
				$thietkeweb = "<a href='http://www.thietkeweb.com/di-dong/' target='_blank' title='thiet ke web' rel='dofollow' class='thietkeweb' >Thiết kế web di động:</a> <strong>";
			}
			$con = str_replace("[MADEBY]", $thietkeweb." <strong><a href='http://www.trust.vn' target='_blank' rel='dofollow' >TRUST.vn</a> </strong>", $con);

		}else{
			$thietkeweb = "<a href='http://www.thietkeweb.com/web-design' target='_blank' title='thiet ke web' rel='dofollow' class='thietkeweb' >Web design:</a>";
			if($vnT->deviceType == "mobile") {
				$thietkeweb = "<a href='http://www.thietkeweb.com/di-dong/' target='_blank' title='thiet ke web' rel='dofollow' class='thietkeweb' >Web mobile:</a>";
			}
			$con = str_replace("[MADEBY]", $thietkeweb." <strong><a href='http://www.trust.vn' target='_blank' rel='dofollow' >TRUST.vn</a> </strong>", $con);
		}
	...
	// Parse box - NTS 6/12/2007
	function parse_box ($boxname, $data)
	{
		$this->reset($boxname);
